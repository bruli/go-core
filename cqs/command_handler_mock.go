...
//			HandleFunc: func(ctx context.Context, cmd Command) ([]event.Event, error) {
...
func (mock *CommandHandlerMock) Handle(ctx context.Context, cmd Command) ([]event.Event, error) {
